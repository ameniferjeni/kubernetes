pipeline {
    ...
    environment {
        IMAGE_NAME = "ameniferjeni/foyer_project"
        IMAGE_TAG = "latest"
        K8S_NAMESPACE = "devops"
        CONTEXT_PATH = "/tp-foyer"
        DOCKERHUB_CREDENTIALS = credentials('3ce804e0-ee34-42a2-b245-c75c40e801ac')
        SONAR_HOST_URL = "http://192.168.158.240:9000"
    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/ameniferjeni/kubernetes.git'
            }
        }
        ...
        stage('Build Docker Image') {
            steps {
                ...
                script {
                    withCredentials([usernamePassword(credentialsId: '3ce804e0-ee34-42a2-b245-c75c40e801ac', usernameVariable: 'DOCKER_USER', passwordVariable: 'DOCKER_PASS')]) {
                        sh """
